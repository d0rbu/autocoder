...
class Coder(ABC):
    ...
    def _generate_refine_prompt(self, specification: Any, files: Set[os.PathLike], feedback: str) -> Any:
        ...
        model_input = [
            system_prompt("You are an assistant that takes in a design specification, a codebase, and feedback from running automated tests. You must rewrite the codebase to match the specification and address feedback, if it needs to be rewritten. Previous code written will be shortened to <code> or truncated. DO NOT do this; you must write out full, valid code. When you are finished, simply respond with \"finish\", absolutely no other characters. You must write the path of the file to write code into. The path can be either absolute or relative to the current working directory. Here are examples:\n\nsrc/main.py\n```\nprint(\"Hello, world!\")```\n\nC:\\Users\\henryc\\Documents\\GitHub\\project\\main.js\n```\nconsole.log(\"Hello, world!\")```"),
    ...
    def _generate_code_prompt(self, code_design: str) -> Any:
        model_input = [
            system_prompt("You are an coding assistant that takes in a design document and creates code that meets the design document. Previous code written will be shortened to <code> or truncated. DO NOT do this; you must write out full, valid code. When you are finished, simply respond with \"finish\", absolutely no other characters. You must write the path of the file to write code into. The path can be either absolute or relative to the current working directory. Here are examples:\n\nsrc/main.py\n```\nprint(\"Hello, world!\")```\n\nC:\\Users\\henryc\\Documents\\GitHub\\project\\main.js\n```\nconsole.log(\"Hello, world!\");```"),
    ...
    def _generate_tests_prompt(self, test_type: Literal["integration", "unit"], specification: Any, files_to_test: Set[os.PathLike], existing_test_files: Set[os.PathLike] | None = None, test_results: Any = None) -> Any:
        ...
        model_input = [
            system_prompt(f"You are an assistant that takes in a design specification, a codebase, and a list of existing {test_type} tests. You must rewrite the existing {test_type} tests to match the specification, if they need to be rewritten. Previous code written will be shortened to <code> or truncated. DO NOT do this; you must write out full, valid code. When you are finished, simply respond with \"finish\", absolutely no other characters. You must write the path of the file to write code into. The path can be either absolute or relative to the current working directory. Here are examples:\n\nsrc/main.py\n```\nprint(\"Hello, world!\")```\n\nC:\\Users\\henryc\\Documents\\GitHub\\project\\main.js\n```\nconsole.log(\"Hello, world!\");```"),
